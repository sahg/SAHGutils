"""Utilities for reading and plotting EUMETSAT MPE data.
...
def read_bin_data(fname):
    ...
    MPE data that are being sent via EumetCast and processed by
    David Taylors MDM software. The first and last values
